...
namespace VVCar.BaseData.Data
{
    ...
    public class CreateDBSeedAction : ICreateDBSeedAction
    {
        ...
        void SeedSysMenu(DbContext context)
        {
            ...
            sysMenuSet.Add(new SysMenu { ID = Guid.Parse("00000000-0000-0000-0000-000000000106"), Name = "创建优惠券", Component = "/CouponAdmin/Index", SysMenuUrl = "/CouponAdmin/Index", ParentID = Guid.Parse("00000000-0000-0000-0000-000000000001"), IsLeaf = true, Type = ESysMenuType.Path, IsAvailable = true, Index = 6 });
            ...
            sysMenuSet.Add(new SysMenu { ID = Guid.Parse("00000000-0000-0000-0000-000000000107"), Name = "优惠券列表", Component = "/CouponAdmin/CouponTemplate", SysMenuUrl = "/CouponAdmin/CouponTemplate", ParentID = Guid.Parse("00000000-0000-0000-0000-000000000001"), IsLeaf = true, Type = ESysMenuType.Path, IsAvailable = true, Index = 7 });
            ...
            sysMenuSet.Add(new SysMenu { ID = Guid.Parse("00000000-0000-0000-0000-000000000108"), Name = "领取记录", Component = "/CouponAdmin/ReceivedCouponRecord", SysMenuUrl = "/CouponAdmin/ReceivedCouponRecord", ParentID = Guid.Parse("00000000-0000-0000-0000-000000000001"), IsLeaf = true, Type = ESysMenuType.Path, IsAvailable = true, Index = 8 });
