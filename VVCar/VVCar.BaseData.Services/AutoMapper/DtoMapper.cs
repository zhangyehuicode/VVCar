        ...
        public static void Initialize() =>
            ...
            Mapper.Initialize(cfg =>
            {
               ...
               .ForMember(dest => dest.Product, opt => opt.MapFrom(src => src.MerchantBargainOrder.Product));
                ...
                cfg.CreateMap<PickUpOrderTaskDistribution, PickUpOrderTaskDistributionDto>()
                .ForMember(dest => dest.UserCode, opt => opt.MapFrom(src => src.User.Code))
                .ForMember(dest => dest.UserName, opt => opt.MapFrom(src => src.User.Name));

                cfg.CreateMap<CarInspectionReport, CarInspectionReportDto>();
                cfg.CreateMap<OrderDividend, OrderDividendDto>();
                cfg.CreateMap<UnsaleProductHistory, UnsaleProductHistoryDto>();
                cfg.CreateMap<DailyExpense, DailyExpenseDto>();
                cfg.CreateMap<MaterialPublishItem, MaterialPublishItemDto>()
                .ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.Material.Name))
                .ForMember(dest => dest.Url, opt => opt.MapFrom(src => src.Material.Url));
