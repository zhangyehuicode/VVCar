...
namespace VVCar.BaseData.Services.DomainServices
{
    ...
    public class MerchantService : DomainServiceBase<IRepository<Merchant>, Merchant, Guid>, IMerchantService
    {
        ...
        public override bool Update(Merchant entity)
        {
            ...
            merchant.DepartmentImgUrl = entity.DepartmentImgUrl;
            ...
            merchant.ExpireDate = entity.ExpireDate;
        ...
        private bool ActivateMerchantDataOperation(Guid merchantId)
        {
            if (merchantId == null)
                return false;
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 1, Name = SysSettingTypes.WXMsg_DeliveryNotify, Caption = "订单发货提醒模板", TemplateName = "订单待发货提醒", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 2, Name = SysSettingTypes.WXMsg_DeliveryRemind, Caption = "订单发货通知模板", TemplateName = "订单发货通知", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 3, Name = SysSettingTypes.WXMsg_ServiceExpiredRemind, Caption = "服务到期提醒消息模板", TemplateName = "服务到期提醒", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 4, Name = SysSettingTypes.WXMsg_Announcement, Caption = "公告通知模板", TemplateName = "项目进展通知", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 5, Name = SysSettingTypes.WXMsg_VerificationSuccess, Caption = "核销成功通知消息模板", TemplateName = "核销成功通知", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 6, Name = SysSettingTypes.WXMsg_MemberRecharge, Caption = "会员储值微信通知消息模板", TemplateName = "会员充值通知", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 7, Name = SysSettingTypes.WXMsg_MemberConsume, Caption = "会员消费微信通知消息模板", TemplateName = "会员消费通知", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 8, Name = SysSettingTypes.WXMsg_MemberAdjust, Caption = "会员账户调整微信通知消息模板", TemplateName = "余额变动提示", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 9, Name = SysSettingTypes.WXMsg_ReceivedSuccess, Caption = "礼品领取成功通知消息模板", TemplateName = "礼品领取成功通知", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 10, Name = SysSettingTypes.WXMsg_OrderSuccess, Caption = "下单成功通知消息模板", TemplateName = "下单成功通知", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 11, Name = SysSettingTypes.WXMsg_OrderRemind, Caption = "新订单提醒消息模板", TemplateName = "新订单提醒", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 12, Name = SysSettingTypes.WXMsg_CouponWillExpire, Caption = "优惠券即将过期微信通知消息模板", TemplateName = "票券过期退款通知", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 13, Name = SysSettingTypes.WXMsg_GameRemind, Caption = "游戏通知消息模板", TemplateName = "孩子开启游戏通知", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 14, Name = SysSettingTypes.WXMsg_AppointmentSuccess, Caption = "预约成功通知消息模板", TemplateName = "预约成功通知", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 15, Name = SysSettingTypes.WXMsg_AppointmentRemind, Caption = "预约提醒通知消息模板", TemplateName = "新预约订单通知", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 16, Name = SysSettingTypes.WXMsg_CrowdOrderSuccess, Caption = "拼单成功通知消息模板", TemplateName = "拼单成功通知", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<Merchant> GetSubMerchants()
        {
