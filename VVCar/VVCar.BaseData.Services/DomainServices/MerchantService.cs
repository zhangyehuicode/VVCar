...
namespace VVCar.BaseData.Services.DomainServices
{
    ...
    public class MerchantService : DomainServiceBase<IRepository<Merchant>, Merchant, Guid>, IMerchantService
    {
        ...
        private bool ActivateMerchantDataOperation(Guid merchantId)
        {
            if (merchantId == null)
                return false;
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 1, Name = SysSettingTypes.WXMsg_DeliveryNotify, Caption = "订单发货提醒模板", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 2, Name = SysSettingTypes.WXMsg_DeliveryRemind, Caption = "订单发货通知模板", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 3, Name = SysSettingTypes.WXMsg_ServiceExpiredRemind, Caption = "服务到期提醒消息模板", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 4, Name = SysSettingTypes.WXMsg_Announcement, Caption = "公告通知模板", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            ...
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 6, Name = SysSettingTypes.WXMsg_MemberRecharge, Caption = "会员储值微信通知消息模板", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            ...
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 8, Name = SysSettingTypes.WXMsg_MemberAdjust, Caption = "会员账户调整微信通知消息模板", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            ...
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 10, Name = SysSettingTypes.WXMsg_OrderSuccess, Caption = "下单成功通知消息模板", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 11, Name = SysSettingTypes.WXMsg_OrderRemind, Caption = "新订单提醒消息模板", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 12, Name = SysSettingTypes.WXMsg_CouponWillExpire, Caption = "优惠券即将过期微信通知消息模板", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 13, Name = SysSettingTypes.WXMsg_GameRemind, Caption = "游戏通知消息模板", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 14, Name = SysSettingTypes.WXMsg_AppointmentSuccess, Caption = "预约成功通知消息模板", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
            SystemSettingRepo.Add(new SystemSetting { ID = Util.NewID(), Index = 15, Name = SysSettingTypes.WXMsg_AppointmentRemind, Caption = "预约提醒通知消息模板", DefaultValue = string.Empty, SettingValue = string.Empty, IsVisible = true, IsAvailable = true, Type = ESystemSettingType.Parameter, CreatedUserID = AppContext.CurrentSession.UserID, CreatedUser = AppContext.CurrentSession.UserName, CreatedDate = DateTime.Now, MerchantID = merchantId, });
