...
namespace VVCar.Areas.Mobile.Controllers
{
    public class AgentController : Controller
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult AgentDepartmentDetails()
        {
            var companyCode = Request["mch"];
            if (string.IsNullOrEmpty(companyCode))
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult ProductRetailStatistic()
        {
            var companyCode = Request["mch"];
            if (string.IsNullOrEmpty(companyCode))
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult ReimbursementCheck()
        {
            var companyCode = Request["mch"];
            if (string.IsNullOrEmpty(companyCode))
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult SuperClassManagement()
        {
            var companyCode = Request["mch"];
            if (string.IsNullOrEmpty(companyCode))
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult GroundCourse()
        {
            var companyCode = Request["mch"];
            if (string.IsNullOrEmpty(companyCode))
            {
