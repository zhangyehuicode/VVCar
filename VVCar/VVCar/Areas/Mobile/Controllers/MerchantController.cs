...
namespace VVCar.Areas.Mobile.Controllers
{
    ...
    public class MerchantController : Controller
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult AdvisementBrowseHistory()
        {
            var companyCode = Request["mch"];
            if (string.IsNullOrEmpty(companyCode))
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult UnsaleProduct()
        {
            var companyCode = Request["mch"];
            if (string.IsNullOrEmpty(companyCode))
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult OperationStatement()
        {
            var companyCode = Request["mch"];
            if (string.IsNullOrEmpty(companyCode))
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult OperationStatementDetails()
        {
            var companyCode = Request["mch"];
            if (string.IsNullOrEmpty(companyCode))
            {
