...
namespace VVCar.Areas.Mobile.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult MerchantCrowdOrder()
        {
            var companyCode = Request["mch"];
            if (string.IsNullOrEmpty(companyCode))
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult MerchantBargainOrder()
        {
            var companyCode = Request["mch"];
            if (string.IsNullOrEmpty(companyCode))
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult MerchantCrowdOrderDetails()
        {
            var companyCode = Request["mch"];
            if (string.IsNullOrEmpty(companyCode))
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult MerchantBargainOrderDetails()
        {
            var companyCode = Request["mch"];
            if (string.IsNullOrEmpty(companyCode))
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult MyMerchantCrowdOrderDetails()
        {
            var companyCode = Request["mch"];
            if (string.IsNullOrEmpty(companyCode))
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult MyMerchantBargainOrderDetails()
        {
            var companyCode = Request["mch"];
            if (string.IsNullOrEmpty(companyCode))
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult CarInspectionReport()
        {
            var companyCode = Request["mch"];
            if (string.IsNullOrEmpty(companyCode))
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult CarInspectionReportDetail()
        {
            var companyCode = Request["mch"];
            if (string.IsNullOrEmpty(companyCode))
            {
