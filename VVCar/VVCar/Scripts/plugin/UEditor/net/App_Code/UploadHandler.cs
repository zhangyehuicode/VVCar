...
public class UploadHandler : Handler
{
    ...
    public override void Process()
    {
        ...
        var fileName = string.Concat("TEMP_", DateTime.Now.ToString("yyyyMMddHHmmssfff"), Path.GetExtension(uploadFileName));
        ...
        try
        {
            ...
            Result.Url = Path.Combine("/Pictures/CouponImg", fileName);
