Ext.define('WX.view.CarBitCoinOrder.CarBitCoinOrderDetails', {
	extend: 'Ext.window.Window',
	alias: 'widget.CarBitCoinOrderDetails',
	title: '订单详情',
	layout: 'vbox',
	width: 550,
	modal: true,
	...
	initComponent: function () {
		...
		var orderItemStore = Ext.create('WX.store.BaseData.CarBitCoinOrderItemStore');
