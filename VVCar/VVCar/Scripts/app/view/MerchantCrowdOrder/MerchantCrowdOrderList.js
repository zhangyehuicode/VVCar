Ext.define('WX.view.MerchantCrowdOrder.MerchantCrowdOrderList', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.MerchantCrowdOrderList',
    title: '拼单',
    store: Ext.create('WX.store.BaseData.MerchantCrowdOrderStore'),
    stripeRows: true,
    loadMask: true,
    closable: true,
    ...
    initComponent: function () {
        ...
        this.tbar = [{
            ...
            action: 'addMerchantCrowdOrder',
            xtype: 'button',
            text: '新增',
            scope: this,
            iconCls: 'fa fa-plus-circle',
        }, {
            action: 'delMerchantCrowdOrder',
            xtype: 'button',
            text: '删除',
            scope: this,
            iconCls: 'fa fa-close',
        ...
        me.columns = [
            ...
            { header: '商品', dataIndex: 'ProductName', flex: 1 },
