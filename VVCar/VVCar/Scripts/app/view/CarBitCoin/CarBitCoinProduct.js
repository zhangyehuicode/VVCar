Ext.define('WX.view.CarBitCoin.CarBitCoinProduct', {
    extend: 'Ext.container.Container',
    alias: 'widget.CarBitCoinProduct',
    title: '车比特产品管理',
    layout: 'hbox',
    align: 'stretch',
    loadMask: true,
    ...
    initComponent: function () {
        var me = this;
        var carBitCoinProductStore = Ext.create('WX.store.BaseData.CarBitCoinProductStore');
        var treeCarBitCoinProductCategoryStore = Ext.create('WX.store.BaseData.CarBitCoinProductCategoryTreeStore');
        var carBitCoinProductTypeStore = Ext.create('WX.store.DataDict.CarBitCoinProductTypeStore');
        me.items = [{
            name: 'treeCarBitCoinProductCategory',
            xtype: 'treepanel',
            title: '产品类别',
            height: '100%',
            width: 200,
            ...
            animate: true,
            displayField: 'Text',
            store: treeCarBitCoinProductCategoryStore,
            bbar: ['->', {
                action: 'manageCarBitCoinProductCategory',
                xtype: 'button',
                text: '分类管理',
                tooltip: '分类管理',
                width: 100,
            ...
            xtype: 'grid',
            name: 'grdCarBitCoinProduct',
            title: '产品列表',
            flex: 1,
            store: carBitCoinProductStore,
            stripeRows: true,
            height: '100%',
            tbar: [{
                xtype: 'form',
            ...
            columns: [
                ...
                { header: '标题', dataIndex: 'Name', width: 180 },
                ...
                {
                    header: '类型', dataIndex: 'CarBitCoinProductType', width: 60,
                    renderer: function (value) {
                        if (value == 0)
                            return '引擎';
                        else
