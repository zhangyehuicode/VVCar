...
namespace YEF.Core.EMail
{
    public class EmailHelper
    {
        ...
        ///<param name="toMails">收件人地址（可以是多个收件人，程序中是以“;"进行区分的）</param>
        ...
        public EmailHelper(string server, string[] toMails, string fromMail, string subject, string emailBody, string username, string password, string port, bool sslEnable, bool pwdCheckEnable)
        {
            try
            {
