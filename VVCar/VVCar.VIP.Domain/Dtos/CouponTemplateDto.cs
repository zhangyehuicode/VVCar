...
namespace VVCar.VIP.Domain.Dtos
{
    ...
    public class CouponTemplateDto
    {
        ...
        /// 审核状态文本
        /// </summary>
        public string AproveStatusText { get; set; }

        /// <summary>
        /// 审核状态
        /// </summary>
        public EApproveStatus AproveStatus { get; set; }
        ...
        /// </summary>
        [Display(Name = "核销方式")]
        public string VerificationModeDesc { get; set; }
        ...
        /// </summary>
        [Display(Name = "适用门店")]
        public IEnumerable<string> ApplyStoresName { get; set; }
        ...
        /// </summary>
        [Display(Name = "适用商品")]
        public string IncludeProductNames { get; set; }

        /// <summary>
        ///  不适用商品名称，以,分隔
        /// </summary>
        [Display(Name = "不适用商品")]
        public string ExcludeProductNames { get; set; }
        ...
        public string PutInDate
        {
            get
            {
                if (string.IsNullOrEmpty(PutInStartDate) || string.IsNullOrEmpty(PutInEndDate))
                {
                    return string.Empty;
                }
                return $"{PutInStartDate}~{PutInEndDate}";
            }
        }
