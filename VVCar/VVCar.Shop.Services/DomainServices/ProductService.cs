...
namespace VVCar.Shop.Services.DomainServices
{
    ...
    public class ProductService : DomainServiceBase<IRepository<Product>, Product, Guid>, IProductService
    {
        ...
        public override bool Update(Product entity)
        {
            ...
            product.IsCommissionRate = entity.IsCommissionRate;
            product.CommissionRate = entity.CommissionRate;
            product.CommissionMoney = entity.CommissionMoney;
            product.IsSalesmanCommissionRate = entity.IsSalesmanCommissionRate;
            product.SalesmanCommissionRate = entity.SalesmanCommissionRate;
            product.SalesmanCommissionMoney = entity.SalesmanCommissionMoney;
            product.IsWholesaleCommissionRate = entity.IsWholesaleCommissionRate;
            product.WholesaleCommissionRate = entity.WholesaleCommissionRate;
            product.WholesaleCommissionMoney = entity.WholesaleCommissionMoney;
            product.IsWholesaleConstructionCommissionRate = entity.IsWholesaleConstructionCommissionRate;
            product.WholesaleConstructionCommissionRate = entity.WholesaleConstructionCommissionRate;
            product.WholesaleConstructionCommissionMoney = entity.WholesaleConstructionCommissionMoney;
